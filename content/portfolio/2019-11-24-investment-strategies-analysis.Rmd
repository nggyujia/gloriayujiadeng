...
In the situation where the client lives 20 more yeras, the expense will be \$45,600 * 20 = \$912,000
In the situation where the client lives 30 more yeras, the expense will be \$45,600 * 30 = \$1,368,000
...
For investment made in yera 2, the return from each year will be reinvested for 8 times (no return at year 2) and the cost will be charged 9 times, so the total amount will be\
